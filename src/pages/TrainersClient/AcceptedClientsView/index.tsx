...
const AcceptedClientsView: React.FC<AcceptedClientsViewProps> = ( { token, clients }) => {
                ...
                <div className="ClientHolderContext">
                    {
                        clients.length === 0 ? (
                            ...
                            clients.map(( client ) => {
                                ...
                                return (
                                    <Link key={client.id} className="Client" to={`/clients/?&client=${client.id}&tab=messages`} title={client.name}>
...
export default AcceptedClientsView;
